...
def test_update_accommodation_not_owner(client, test_accommodation, test_admin, admin_token):
    update_data = {
...
def test_delete_accommodation_not_owner(client, test_accommodation, test_admin, admin_token):
    response = client.delete(
        f'/accommodations/{test_accommodation.id}',
        headers={'Authorization': f'Bearer {admin_token}'}
    )
