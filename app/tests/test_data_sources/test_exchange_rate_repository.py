...
class TestExchangeRateRepository:
    ...
    def test_should_raise_when_access_to_the_repository_is_forbidden(
    ...
    def test_should_return_exchange_rate_for_given_country_code_when_it_exists(
        self, fake_request_handler
    ):
        ...
        fake_request_handler.get.return_value.json.return_value = {
            "result": "success",
            "conversion_rates": {base_currency: 1, currency_to_convert: expected_rate},
        }
        ...
        conversion_rates = exchange_rate_repository.get_exchange_rate_for_country(
            currency_to_convert, base_currency
        )
    ...
    def test_should_raise_when_base_country_code_does_not_exist_in_conversion_rates(
        self, fake_request_handler
    ):
        base_currency = CountryCode("USD")
    ...
    def test_should_raise_when_target_currency_does_not_have_conversion_rate_for_given_base_currency(
        self, fake_request_handler
    ):
        base_currency = CountryCode("USD")
    ...
    def test_should_raise_when_conversion_rate_is_not_a_valid_rate(
        self, fake_request_handler, invalid_rate
    ):
        base_currency = CountryCode("USD")
        target_currency_to_convert = CountryCode("AUD")
